...
I’ve finished Inner Communication. I need to understand the idea of communication in the book is the context of social philosophy. Communication itself is certainly internal. Successful communication ‘internalises’ the communicators. And form a recognition. A society. All is soft inside.
...
- We can the change this biases.
- Our brain is still living stone ages.
- Brain prioritises survival over accuracy on.
...
- Secodness is ‘thou’, the mind and psychology.
...
- Or, ‘I’ controls ‘self’.
- Your mind carefully select your experience and create a meaningful story to remember.
...
- Similar to muscles self-control get
...
- Neural network can altered by repeated stimuation
- Hebbian principle: Neurons that fire together, wire together.
- Neural network remains malleable entire your life.
...
- Self is a living organism that consists a constant interaction of many entities.
- Scholars agree that self is a constant storytelling.
- Thoughts and consciousness themselves are communication already.
- Storytelling or meaning completes itself by being shared to others.
...
- Writing short essays of core values increases actual achivement.
...
- **According to Jaynes, use of language have resulted in consciousness.**
- Modern society have lost true colloquialism.
...
- Wigner’s cat divide the universe by shared status of mind.
- Some says there’s only one shared status and all consciousness are affected.
- Bohm is the most prominent theoretical physicist is ‘connectivity’ and ‘integrity’.
...
- **It’s critical for mental fitness to work on this premises.**
...
- Mental fitness make you turn around and see inside of your boundary.
- Phasic alertness comes from outside like a siren.
- Tonic alertness comes from inside. It maintain the identical state of awake for a long time.
...
- It means that there’s an imbalance between premises and new informations.
...
- Predictable rewards does not fine dopamine hits.
...
- Not just the structure, but the process of inference are overlapped.
...
- Anger is generated. It’s not ‘caused’ by the event you might blame to.
...
- Confilct doesn’t exist between people. It’s locked in individuals.
...
- Head, neck, vowels, and some other parts are directly connected to your brain.
...
- You listen tranquility only when the noise disappears.
...
- Consciousness integrates many experiences and makes it reportable.
...
- Forgiving forgives the past and give everything for the future.
...
I tried to rephrase or copy the parts of the book I have highlighted. It helps but I should change how I read books. Every chapter gives me profound inspiration. Every chapter worths a dedicated post or something alike.
...
- Mind cannot remain in control without ‘time’. The timeless is Now is the end of it.
...
- Intense presences is needed when the self-image is threatened, a challenge triggers fear, or an emotional complex from the past is brought up.

### Letting Go of Psychological Time

- Non-forgiveness implies a heave burden of psychological time.
...
- The wars for ideology is an example of future heaven creating the present hell.
...
- Hope keeps you focused on the future, perpetuation your denial of the Now.
...
- Be glad at your, or your partners madness, for the unconsciousness is brought up.
