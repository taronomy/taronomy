...
Those decisions were applied to the algorithm, the design, and the prompt. You can check your Pillars and find out what they mean in [Pillars app](54/pillars.webm). You can get a reading currently at €8. The app is not complete in any sense yet. But I'm hoping to expand on features and reusability with daily, yearly, and relationship readings.

Enjoy!

# Building Pillars

For the last a dozen of weeks, I've been working on the foundation for [creator apps](#creator-apps) and the an example: [Pillars](54/pillars.webm). This is a brief report for my choices and what has been done. 
