...
![Pillars](pillars.avif){:standalone}
...
My main goal was to provide _intuitive graphics and an interface_. The result is the brutalist style and mobile-first interface you can see in [the app](pillars.webm).
...
![Stems](pillars-stems.avif){:standalone}
...
![Bases](pillars-bases.avif){:standalone}
...
![Aspects](pillars-aspects.avif){:standalone}
...
![Phases](pillars-phases.avif){:standalone}
...
For the last dozen weeks, I've been working on the foundation for [creator apps](#creator-apps) and an example: [Pillars](pillars.webm). This is a brief report for my choices and what has been done. 
