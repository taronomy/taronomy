...
The problem a persona solves is the *volatility* that comes from working on one's own thing. It's easy to lost the thread. Creative work easily vaporises because it's about *change* in and of itself. Context decays faster than work compounds. And when no one else is involved, nobody is held accountable.
