...
Uniqueness is also what AI persona solves in terms of technological progress. Uniqueness introduces computational bottleneck, dissipation of information. That's why traditional society had to rely on uniformity so they can compute information across society with the meagre capacity. Banks and markets enabled much more complex social information processing as long as it can be quantified. Now, LLMs can crunch a volume of context for everyone. It doesn't have to be numbers because everything is a number for machines. That's persona.
