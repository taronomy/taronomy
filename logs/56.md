...
'Project' has been my mental model for the temporary and granular social systems. It means I've been handling social systems more like _plans_, which is the initial meaning of 'proicere'. There are two reasons: 
...
_One who doesn't see their pattern is forever stuck in the pattern._ And they themselves become the most prominent opponent of the idea of their own repetition. They believe they make choices. They believe they are autonomous. And make the same mistakes over and over again.
...
The words I've been reciting forever. But each of them doesn't really make _it_ happen. They hold significant nuances for each other. _Together, they make this one thing I cannot name._ So I'm charting the constellation so I can see a figure from it and name it someday.
...
This idea itself is ancient. But it provides a significant implication for further development into autonomy. _We can shape ourselves only when we let go of ourselves._ It doesn't need to be 'letting go'. Grow bigger, go higher, _get over yourself any way possible_. I already have it in my statement:
...
Autonomy often means independence. And independence usually implies dependence. My emphasis is on autopoietic capability. Posthumanism attempts to make clear that "autonomy" is not about being stuck to oneself pivoting around. _Here, autonomy means moving ourselves to somewhere we haven't been without falling apart._ It does not mean becoming an installment because we might fall apart. 
...
- People need more autonomy in the future as machine intelligence replaces workforce. What are they when no one needs them? They need to be _themselves_ to create any value soon enough and nobody is there to tell them what that is when they are unemployed and broke.
...
Then what is the autonomy _based on_ in ludic social systems? That's where _plays_ come into, well, play.
...
As I keep working on it, the triad is coming into a perspective. Instead of the linear projection of idea-strategy-practice, now I see them as a radial layers. Posthumanism is the innermost essence. Autonomy is the work of each person. And plays are the external systems that hold individuals as society. I reckon in has always been this way. 

My focus was too biased to making plays interesting. As a matter of fact, the meat of this triad is _autonomy_. For people, it means becoming or creating something unique and meaningful. It's more than having such an agency. It's more about being generative order for oneself. Agency navigates given structure. Autonomy creates that structure for oneself. Plays should serve this purpose.
