...
I've decided to work on the persona idea. At this point, there is a gap between the parasocial creators and ludic social systems. Instead of measuring their difference side by side, I want to have an operational perspective that starts from persona then marches into plays. Persona can scope what plays are going to be. Like ledgers and the law describe transactions.

The platform can start as an offering for parasociality. But I will steer it into a general social interface that delivers what I promised. It already has a start when creators work on their personae. Self-reference enables autonomy. Of course it'd be different from the ego. It will feel uncanny. But that's the new reality we create for ourselves. The users also build their own personae talking to the creators.
...
Yet I don't see how the persona ideas seamlessly integrate to the plays idea. I was always thinking about real people in real activities and experience. How could talking to an LLM lead to some real experience? 

But I can't deny the profound potential behind it. AI is growing rapidly in its infancy. But it's mostly for work and knowledge, not social interactions. The world has a lot more people than Claude. And LLMs do affect the human psyche. After all, society is storytelling. Seth called for AI that connects people in [The next generation of AI businesses](https://seths.blog/2026/02/the-next-generation-of-ai-businesses/).

There are real social problems I can approach once I secure this foundation. People always want good people and relationships. Social interactions happen anyway, all the time. My work is useful as long as contribute to them some how, even a little.

Play design will haunt me for a while. That's because I want a perfect design, because I want to feel relief. That's only my ego I have to let go every time it pops up. And maybe it will save the day. Maybe.

At the end of the day, I just want to help people find their meaning in this society. I believe such society is most available when people create and iterate deliverately. It also applies to myself. I wanted to truly belong to what I am. Not everyone is creative and sociable. But anyone can add value if we find the right alignment.
