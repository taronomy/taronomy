...
Finalised the code highlight colours. _macOS classic_ was the reference I was looking for. Also refined typography with true small caps and hanging punctuations. Style matters.
...
Like plays, this _joy_ is supposed to be more than frivolous fun. But when _it_ happens, one certainly feel joy. Play is how I approach joy. But joy doesn't require a formal play even though one might assert there are plays we don't see when we feel joy.
...
Then what do plays needs to be? At first, my intuition didn't get farther than impressions. I felt like I should somehow joyful experience that I don't know how. Talking to Chat was much more productive. I've identified a couple of objectives.
...
The first one, _entrance_, makes a crucial distinction. Joy might be more substantial, but still I can't directly target it because people decide joy, not I, not even the systems. What I can do is to be there as an open door so people and the systems start when they flop. _Just the start._ That's the responsibility of the meta-system.
...
By instinction, my first notes called the idea "new plays" like new place for plays. "Protocol" is another keyword I am holding for a long time which means the first page that initiates continued interactions. The systems don't need to dictate the entirety of experience. That is impossible.
