...
- The new sythesis was a return to the creative work, myself in creative collectives, leaning into the industry. 
- The _fun_ in the work before I get too serious. And my background in fine art.
- PersonAI could help that missing "social container". 
- Being able to talk to others and oneself, which is other. 
- Updating the persona in the interactions. Helping networking after that somehow.
- Delphi is for few leaders.
- "Starting again" never better than computers.
- Plays don't need to be formal. Chat session is play too. 
- I can organise plays in reality. Personae do plays their own ways. Different plays, both valid as long as they help.
- Autonomy can be the reason for people to make input. Plays could be organised from the app.
- Only when I'd be specific, I see hope in the purpose of social environment. Beyond that, it takes a lot more. And I should keep my focus on creatives. They need it. They make it meaningful.

### OrganisAItions

- Interactions could automatically generate organisation proposals?
- [Organisations are decisions]
