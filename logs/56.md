...
There are two major challenges. First, I need to be open for my environment but not get carried away. In particular, the AI apps and communities are a vortex I want to work with. Chat apps probably the archetype Ludics wants to differentiate from. People are already trying out things I can't imagine. That is an opportunity. Second, translating the theory into reality. 

- Self-correction?
- Ludicity, the gap
- Assumption of 'character as value'
