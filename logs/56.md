...
It means probably the most important utility of a persona make it a thing. What's *a thing*? It's what people talk about. When a couple of people share a concept under a name, and the linkage doesn't easily change because it's shared, we call it a thing.
...
Applying it to social system means to extracting those values and make them the baseline, not a particular effort. For example, capitalism embodies phronesis by selection of products, arete by reinvested profit and eunoia by belief that customers will make rational decision that will benefit their lives.
...
There are many moving and missing part here. But what's clear is that Ludics, ludicity, are all about this linkage between the persona and the author that creates social reality.
