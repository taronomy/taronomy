...
> *Personae* create a layer of virtual sociality. A persona is an instruction to an LLM to mirror the author. The persona picks up what to mirror in interactions with the author like a chat. The persona also represents the author as a thin mask. Interacting with a persona implies interacting with the author.
> 
