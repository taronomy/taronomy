...
Underneath that, posthumanism is the philosophical essence that induces autonomy and normalise it for oneself. It deconstructs self so it's obvious that self changes. It keeps self malleable for constant flow of change. It removes finality from identity. That's how people can take more experimental and progressive approach to life. For analogy, it could be compared to the evangelical nature of Christianity that helped the Age of Discovery. It's an idea invisible unless told. But it's the excuse for people to make the extra effort into the unknown from within.
