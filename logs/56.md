...
"Make yourself." That's more like it. It sounds me too. I'm so helplessly myself. And I keep telling people to have their own opinions. It's pluralist because everyone is different. It's permissive and relieving. Also, we can change when we know what we are. Continued change takes continued self. [^read]
...
My journey so far has been my struggle to be myself truly.[^read] I was afraid I would dissolve into the noise of society if I don't. And this experience makes my mission for differentiation of people personal for me. I want to secure a bottom-up society so this can be the default.
...
Instead, I find personae themselves to be a form of plays, 'frames that people voluntarily make binding'. This is because a persona is *a social reality* someone create on the personal level. The recognition a persona scales is both power and constraints. It binds the author too. *Because people can't escape how others know them.*[^read] A persona gives you more control, but the essence of social recognition doesn't change. It's the symbolic reality we create. And that's play. 
...
In a nutshell, it's *AI personae as transient masks*. This 'persona' does not a generalised profile or an hypothetical actor. Unlike an impersonating chat bot, the chat goes directly to the author. It's a real mask that covers a real face of a real person, just symbolic. It's quite literally the origin of the word: '𐌘𐌄𐌓𐌔𐌖'[^persu], 'πρόσωπον'[^prosopon], 'mask' or 'face'. 

[^persu]: φersu. 'Mask' or 'actor' in Etruscan.

[^prosopon]: prósōpon. 'Face' or 'visage' in ancient Greek.
...
Going into the product realm, I see countless new questions and things to do. The complexity is nauseating, but it's way less than 'social systems'. I survived that, I'll survive this one.
...
I named the third function "🚪Door" after 🪞Mirror and 🪟Window. I don't know what it is yet. And I don't want to presume what it is. Even the complexity from Window is unbearable now. I should focus on the Mirror for the moment.
...
Just like any other social system, this new atom of knowledge dissipates quickly unless captured. It needs a place to live so the individual can keep *knowing* what they are. Just like tomes did, Ludics works as the reference point. 'Play' means that people consciously enact what they are from this reference.

# Week 30

Fixed broken ToC links above the page. I didn't know tabbing doesn't cycle through the `ol.inline` style. It turns out `display: content` somehow disables the behaviour. 

Tools are meant to me reliable. But even then, I can't predict everything or expect perfection. It's the care, engagement and serendipity that makes it work.

# Week 31

Adjusted Sapir. The numpad is reversed in particular. Meta keys are rearranged and the question mark is returned to its original position because I realised that `shift + /` is just better. 

Hyphen-minus and underscore are swapped because 'under' doesn't necessarily mean 'lower'. Hyphen-minus can stay with the numpad without duplication. Underscore actually belongs to the 'special glyphs' party.

# Week 32

Hex rightly lacks a good library for Turso because it's literally released yesterday. This is the path I chose. No Phoenix or Ecto. Just Elixir and "Cake" architecture. 

I went through the entries in the last dozen weeks to realign with my vision. I should do this weekly, not every now and then. I haven't made any progress with outreach or workout. Let's keep things on track. I've got this.

# Week 33 

Now the app has a complete authentication cycle. This is a much better version of what I attempted a couple of years ago. I only need to smooth the edges before I continue.

For the Turso adapter, I probably want to work on Iku myself. Not a good idea, but a worthy one.

# Week 34

I have finalised authentication structure and process. It came out a lot simpler than the initial draft. I see why minimalism is difficult and almost impossible in an organisation. Mutilating unnecessary parts often come off as a waste of time. One might prefer a pile of dirt over cleanliness as a proof of something. Pain, I guess.

Working on the foundation, I reckoned that I want to work on an open-source project. Turso is an exciting database project from briliant minds and Elixir doesn't have a working library. There should be *Iku*, which works well with *Mar*. Then I want to work on *Mar*. 

I know these things take commitments. And I should get the priority right. Ludics should be their existential foundation first. Once I need the technology, the commitments will make themselves.

- [x] Auth
- [ ] Ludics.ai
- [ ] Iku and Mar 0.3

It's time to revisit what Ludics is meant to be.

# Week 35

> When we are free from what we are, we can shape our lives experimenting with what gives us joy.[*](#when-stars-are-aligned)

I wanted to identify *a solid value proposition* after [ludicity](#ludicity). It's evident in [week 23](#week-23)/[persona](#persona) but left as is.

> Also, I need to understand what ‘persona’ means to people in reality. 

I need this before I go into further work for the foundation because this is the very 'why', the raison d'être. I come from social systems, because I thought, and still think, that's the most important thing to meddle with in life. This is the same axiological question, but on the other end. *What a persona is for?* It might be the same thing as what it came *from*, maybe not. My job is to articulate whatever it is.

[The mission](#the-mission) already explains a lot.

> Create value from your unique character.

This is the inflection point. The longer version of this statement clearly comes from the *source* of personae, not the *end*. The ultimate social system is the one that maximises *autonomy*, so people can systemise themselves. That's the structural truth and the conclusion of my study. Now, what does it mean to each person in their life?

This is my life's work. It has to come from myself. I already have this in my mind. I just need to see it right.

## The repository

> A place to safely store my social self.

"What should Ludics *feel* like to its users? What's the real use of a persona?" That was my question. It's not about how it works, what it hopefully means or what's the grandiose potential it promises. I was looking for something more visceral. It was something close to Godin's idea of Linchpin: "will they miss you?" Would people miss Ludics when it's gone? Why? It's a fundamentally different kind of question compared to my philosophical, visionary erudition. It's something real, human and perhaps painful.

And the answer is deceptively banal. Its lack of excitement has convinced me that this is the right answer. Because this is the boring foundation of anything exciting in my work.

**Ludics must be a place they can save value so people can rest assured that their time and effort won't evaporate so they don't have to start over from scratch.**

It's like a bank, or GitHub. Conversely, Ludics serves for the anxiety where people worry they won't be able to reap from their work. Ludics let them own the social value they created in their hands when they feel like they don't matter.

I'm lacking better words for it at the moment. For comparison, there has been many other candidates. Ludics could be:

- where people connect, against isolation
- where they develop character, against meaninglessness
- where they scale their social self, like those platforms
- where people play, be creative and transcend themselves 
- on and on

But no. My most insightful writings and conversations with LLMs helped me delineate what's most important right now:

- [the objective](#the-objective)
- [week 11 intro](#week-11)
- [talk with Chat](56/69df94f1-74bc-83a2-90af-5903c57668a2)
- [masquerAIde](#masqueraide)
- [persona definition](#persona-definition)
- [ludicity](#ludicity)
- [the first diamond](#the-first-diamond)

People are already trying to create and build something special. The problem is that those values dissipate quickly when not captured and stabilised somehow. The entropy frustrates people and make them hesitate. This is the pain a persona must mitigate. 

Once the critical mass, people will need to keep a persona because it'd be a common expectation just like we expect an open-source project to be on GitHub. But people needed a remote repository way before it was popular because of the very fear of annihilation. A persona is meant to protect the author from such anxiety.

This is the level of work Ludics is currently at. All the other exciting ideas rely on this low-level stability. This is the atom of ludicity.

# Week 36

I'm taking a sanity day. It's more than a day off. It's the day dedicated for the practice of awarenesse and consciousness that lets the voices subside.

## Autonomy.

> People can decide how their worlds work and it's better for everyone that way. My work is to enable it.

My deepest inspiration always has been *autonomy*. To the life itself, it means *autopoiesis*. In modern society, it means *self-governance*. Conventional politics would picture it as a small community running its own bureaucracy. I imagine every individual growing their own value online.

And a persona is a tool for autonomy. That is the alignment I should make. I used to contemplate 'how to autonomy'. Now with virtual persona, I should find its use in, not entertainment or self-help, but autonomy.

I had lost this crucial distinction as I buried my head in code. It's easy to forget what's truly important when I'm busy with a pile of things to do. Features come off as cumbersome, making me ask "why am I doing this again?" It's never for money.

It's autonomy. Because life in human society is painful without some order we choose ourselves. Because the external order enslaves us when we don't stand up for something. And because people *can* create their own social systems. 

That's why Ludics must be the sturdy repository. Systems need some level of stability in order to function. Ludics is going to be the guideline for autonomy. A persona represents each person on this new field of sociality.

## More than an means to an end

I'm recalibrating before I continue with the development. The next step includes the persona feature itself. And I need a clear focus to draw its design from a purpose. But now, focus has shifted from the vision and the mission because I'm about to spend time for a real AI feature that takes time and resources.

The value proposition is there and it's good enough. In post-AI society, each person must create something unique. Ludics helps them differentiate themselves from others by externalising their own characters.

But that's the *whole* story of the user. It's a different story when I see it from the feature itself I'm going to build. [Week 16](#week-16) partly answers to this gap. The app can't magically inspire someone to create. People can. Most of the work should happen in real life. The app can only store, organise and, hopefully, amplify what people create.

What the app, the feature should really focus? What's the narrow edge it should have? It comes down to 

- the actual problem a persona wants to solve
- its design 
- and its own *differentiation* from other AI solutions.

The problem a persona solves is the *volatility* that comes from working on one's own thing. It's easy to lose the thread. Creative work easily vaporises because it's about *change* in and of itself. Context decays faster than work compounds. And when no one else is involved, nobody is held accountable.

How does the design of a persona addresses this problem? The most important part is *having the work out there*, not some vague creative hunch in one's belly. Yet, the work doesn't have to be a well defined project or anything. The work exists as a part of a person, or a persona. It keeps the unique work solid and flexible at the same time.

Compared to the incumbent AI chat apps, a persona is more of a recipient of the work rather than a tool they use for the work in the middle. The author works *on* their persona. It's not the means but *the end*. 

Technically, they can save and retrieve the information about work in Claude or Notion app. That's why Ludics should work on how to shape and organise that information like a human mind. That's what a persona is. Not just a pool of information but the living spirit, the ethos.

# Week 37

Now I have the blueprint. The foundation still needs work, a solid work. I'm going to incorporate Turso with Iku and use a better version of Mar.

Aside from that, this is the perfect time to go to people and validate a product. I don't have any hesitation for what I vendor now. I only need to help people excel.

## Founder mode

My vision comes down to letting people author their own order in this world we all share, so they don't succumb and get consumed by the external order which is mechanical, inorganic and often inhuman. That's what I call *autonomy*: not just arbitrary personal freedom but the functional correlation, the vertical alignment between the person and society.

The overall strategy is to utilise the powerful technology of AI as the layer of symbolic reality for autonomy. Persona is one idea, literally masking people in society. But the approach itself is broader than that. The point is in *play*: creation of unique experience between symbolic reality and physical reality.

What does it take? Go founder mode. Ask people. Sell MVP before it exists. See what promise people buy. Not to make money but to really know them.

## A thing

The marketing of a persona comes down to making itself *a thing*. That's why utilitarian messages come off underwhelming. It's not a best tool but a cultural object that people project their desires.

It means probably the most important utility of a persona make it a thing. What's *a thing*?[^thing] It's what people talk about. When a couple of people share a concept under a name, and the linkage doesn't easily change because it's shared, we call it a thing.

[^thing]: Later, I learnt that 'þing' means literal gathering in the Germanic word root.

Then probably that sharing, the network, is what it actually takes. When Instagram became indispensible, people decided to garden their profiles like their life's work. To Ludics, it means people genuinely thinking "my persona embodies what I'm doing with my life. It's my thing."

And it's my obligation to make that happen.

## Create your AI persona

> Create your AI persona.

It's that simple. Straightforward. Its directness makes me think what an AI persona should be. This is the vibe.

If I remember the Collins-Porras framework correctly, my vision is:

1. Values, beliefs, assumptions: social systems. I also believe that social systems are the meta values.
2. Purpose: autonomy. Period.
3. Mission: AI persona.

The BHAG and the description remain. And they should come from the mission. I used to feel putting it just "AI persona" is too banal because it's not a very special concept. Not anymore. Now I'm confident that's the work. Research existing practices for AI persona/characters. (not products, I've seen enough of those) And write the simplest possible value prop.
...
That's the question that narrows down 'why'. Autonomy is for everyone. (at least I'd claim so) Persona is not. A particular solution takes a particular audience. It creates tension in society before a major movement. Some are skeptics, some would ignore and some are early-adopters.

Broadly, they are creatives. With more nuance, it's the people who want to develop their own unique characters and create value independently. With more context, it's when they are trying to do so but stuck and lost because creative work vaporise, especially when it only exists in one's mind.

In reality, it's the first dozen people who pays for it. And that's the difference.

## Egoist machine

There's a new fascinating entry in YC 2026 Summer roster. [Egoist](https://ego.ist). 

> **Make it all about you.**
>
> Carry your preferences, work, relationships, and identity across AI applications without starting over every time. Private by default, free for life.
>
> **Turn your ego into an AI passport, so you never have to start from scratch.**

Yup. It's that similar. And I've also found some more:

- [Uare](https://www.uare.ai) like "You Intelligence" I thought.
- [Aego](https://www.beyouraego.com) like, um, ego.
- [PersonalAI](https://www.personal.ai)

They all have a more personal purpose compared to that of Delphi. They prove once again that the idea of persona is nothing new. People are already doing it and there is a market for it. Then the differentiator is the future they promise rather than what's in the box.

Egoist goes Robinhood. "Every big company has a version of you. But you should own that. We bring it back to you." Their ultimatum is a hardware passport that keeps one's context.

Ludics didn't promise data ownership. It has pledged to let people keep creating so nobody can pretend they own the ever-transforming identity. The app supports them as a repository but persistence is not the point. *The point is enabling change with such stability because people can't try things when trying things doesn't add up and only hurts them.*

## The social layer

The research into similar projects makes one things crystal clear: persona is not new, the use of it is. The projects work around the same concept of persona for different purpose: data ownership, monetisation, entertainment and so on. It's a clear sign that I must focus on the unique purpose, not persona itself. 

For the user, I've been putting 'character' forward. But in a more general sense, it's something much more like 'social accountability'. And that's also close to what Aristotle asked from ethos:

- Phronesis: judgement. To me, it means the distinctive part of the character. Two people of equally sane ethos might choose different paths because they come from different versions of reality. This is the divergence of character.
- Arete: excellence. This is the converging aspect of character. Regardless to one's phronesis, one must make decisions to pursue greatness, not mediocrity. This is a necessity to make their arbitrary phronesis credible.
- Eunoia: kindness. This is a more tactical and immediate alignment of interest. Anything good can be used to manipulate people into a trap. Eunoia means the genuine intention to use one's phronesis and arete for the good of the stakeholders.

Phronesis makes someone different. Arete makes the difference great. Eunoia makes them the lead with the different greatness.

Applying it to social system means extracting those values and making them the baseline, not a particular effort. For example, capitalism embodies phronesis by selection of products, arete by reinvested profit and eunoia by belief that customers will make rational decision that will benefit their lives.

### Intersubjective enactment

How could a persona make that happen? I should start with this, not what a persona is. Persona itself is not new. Some people might abhor the idea that a persona can imitate their behaviour but some others are already used to it. And that's exactly why the idea of persona itself is not a differentiator: people either hate it or take it granted. What matters is what the persona is for. Is it a hostile persona that maximises the expense and screen time? Is it a neutral vault for the person has created? Or is it a feedback cycle that makes the author create and grow?

There are things to figure out. But I already have some ideas scattered in this note, [last year's](55) and the archive. Most importantly, I imagined a persona as a literal social masking for the author. It means that the persona should be the perceived social reality of the author. Think how a politician would be different in public and private. One signals a shallow ripple across the vast society, the other is as deep as the ocean but contained within one's mind.

> A **persona** is *a strategic mask of identity in public*

I fell short of writing what I wanted to write in [that entry](#dramatis-personai). But this gap, the publicity of one's percieved social image, the representation, is what I wanted to capture all along, not just Ludics.

> The recognition a persona scales is both power and constraints. It binds the author too. *Because people can't escape how others know them.* —[plays: personae as frames](#plays-personae-as-frames)

This is supposed to enable a new and better social organisation because people need to maintain their social image for recognition. People are bound to their social representation. This is precisely what I meant to do in the first place. To structure trust in a more flexible, reliable and granular way. 

> - Autonomy, power over self, promises
> - Exchange of power, negotiation of terms and conditions, contract of autonomy

Now, they are all coming down to something. Social recognition is crucial. We can change how society work when we can work with social recognition. And persona creates the gap between the people and their social image. People liberate themselves in ludicity.

A contrived example would be commercial endorsement. Celebrities stand in a camera holding some luxury cosmetics and fashion when they don't personally like or use them. Influencers do something similar but people generally expect a bit more authenticity from them because social media are supposed to be human-scale productions. They create a sense of social reality either way.

What if the author of the persona can promise a company to inject a piece of prompt that endorses their product? There could be a contract. This is the kind of social accountability. The quality and intensity of the endorsement is up to the injected prompt. It could be subtle or straight-up sales pitch. 

What matter is that there are audience on the other side of the persona. They would assume this person(a) endorses the product, identifying the persona with the author in varying integrity. It will also affect the author to some degree. The persona can't dictate the author but it's not a pure fiction either. It's an *intersubjective enactment*.

There are many moving and missing parts here. But what's clear is that Ludics, ludicity, are all about this linkage between the persona and the author that creates social reality.

# Week 38

What product intersubjective enactment makes? The answer is incredibly obvious: collaboration.

## Constellation

Open collaboration is one of the oldest inspirations of mine. I've built the idea of "studios" around this future. People freely creating value together floating above the rigid corporate/governmental structures. The network of free workers is what necessitates autonomy and also what enables autonomy.

But working together is *hard*, let alone out in the open. The main villain is the lack of trust. Goodwill doesn't penetrate when the work grows in complexity. People disappoint one another not because they are malicious but *human*. That's why people end up working for centralised organisations and tolerate mediocrity for predictability.

This is what a persona changes. *A growing feedback cycle of trust* that lets people keep creating together and weaves a constellation of small teams and individuals. This is precisely how commerce instigated modernisation.

It also provides the design and product of a persona with a practical precursor. Why would someone commit their own social reputation to their persona? It's not because a lone artist wants to get enlightened. It's because they need to *access society* somehow. 

> Similarly, individual creatives may not be obliged to create digital twins for themselves except for some nice-to-have utilities like the alleged self-awareness. The real demand emerges when they collaborate in the open.[*](#persona-definition)

> - Lets them "collaborate" passively by renting their names.[*](#the-bridge)

> - Source of truth for creative collaboration[*](#social-use-of-ai)

> - Source of truth for creative collaboration.[*](#phase-2-connection)

(I actually wrote the same line twice with and without a period)

In a conversation, Claude told me that a persona can work like debt. When someone commits to some social obligations, they are taking a leverage. Stakeholders can support the challenger and provide resources because the success of the commitment matters to them. If it's a success, the record of commitment can be the stepping stone for the challenger. Both works as incentives for the challenger to tend to their character and the persona.

Now, this is not going to be a mediocre project management gadget wrapped in AI buzzwords. This value proposition is only one aspect of Ludics. Ludics must consolidate other aspects to present something different. But this is certainly a strong value prop with real demand. People are the biggest challenge in working together. [Problem-solver problem](55#problem-solver-problem) addressed to this pain last year. My focus was on projects then. Like logistics and bookkeeping are different parts of one change, projects and character should go together in this new vision for the constellation.

## Trust

**'Trust'** closes the loop between individuality and sociality. Persisting one's own work translates to *self-trust*. Connecting them becomes *social trust*. And personae are at the centre of them making the both possible.

This delineation is precisely what I was looking for. A persona is not just for lone self-awareness or social credits. It's the instrument for the vertical alignment of the people and their civilisation. That's why a persona is both the means and the end.

'Trust' also synthesises the prior discussions and questions. It's both my passion and the value proposition. I've been thinking about trust since before this research began. Blockchain technology back then was referred as "trust machine". I was intrigued because *trust* is the foundation of society. 

Almost a decade after, here we are. In a trust-lacking society, people succumb to the central authority for basic stability. When they can create trust themselves, that's the tipping point.

> What's the social value a persona creates?

I had to answer this because "collaboration" itself wouldn't make the product. Ludics isn't meant to be a tool for collaboration per se. Collaboration is only an angle that makes persona irresistible.

I've been combing through words to find the right phrase to define the product. It started as a copywriting task, but quickly grew into a checkup for the whole perspective of myself.

At first, I've been ruminating "what's the nature of the actual pain in working together?". It was evident as in [problem-solver problem](55#problem-solver-problem). Then I also asked "does it make Ludics special compared to the other persona apps?". Those questions filtered out so many phrases for value propositions. "Seen as yourself" or "grow your persona" didn't survive.

Then I asked: "what do I really want myself?" I searched for "want" in this note. The result gave me the new level of synthesis. I've always wanted to helm people "be themselves". My entire work was my 'struggle to be myself' like [the struggle for recognition](51#the-struggle-for-recognition). 

To be better recognised as oneself, one must be credited as oneself. And it can only be done by others. People can't escape how others see them. *With personae, they have control over what others they are.* And that's how people "be themselves", not in isolation but in alignment.

It was not about "talk to yourself" kind of self-indulging identity building. It was about how people truly want to represent themselves to the others. And the others had to agree, creating a public façade.

Thus far, the keyword on top of my head was "credit". 'Credere' means 'to believe'. I needed a better word for this. It took some hours until I reach the simple word of 'trust'.

> Build *trust* through your AI persona.

Against our intuition, this trust is far from validation of solid truth. It's *creation of flexible truths* enabled by *ludicity* that separates and externalises our character from us.
...
People react to vivid stories and visceral messages. 'AI persona' alone is enough to start a conversation. But it's not enough to hook people in. 

This hook has to come from 'trust' or the lack of it. There are accounts where people suffer uncertainty, mistrust and confusion in a collaboration. They also tend to frustrate potential collaborative opportunities.

This frustration stems from what we can't systemise. And *personality* is the usual culprit. When people can't systemise personality, they rely on rigid hierarchy, fungible capital and scalable media.

That's where AI persona comes in. AI can systemise personality and society in its extent.

Those are the problem and the solution. But selling it takes more than that. What's the life we promise? For whom?

It has something to do with joy and work. People need to create value but materials and merchandises are not as valuable as when they initiated modernisation. To create further value, people have to create more than those: enjoying one's work, working like playing.

The ideal initial target is *a creative collective*. They are project-based, not employment. That makes the work flexible but also unstable. They need to constantly create trust in order to continue for themselves and for the collective.

## My thing

My thing is to help people be something. There are many ways to put it. One version would be 'fully become what you are'. This means more than 'be yourself'. It means there is no fixed "yourself" and you have to create the *thing*.

But creating something for oneself takes a lot. That's why I am separating oneself and their character in a persona. The character might not be identical to the existence, but we gain a space to work on the character detached from it. It might not be a perfect representation of ourselves, albeit useful and malleable.

And my project, Ludics and the persona feature are all about making it actually possible to do that so people can put their character out somewhere, shaping what they are in their own perspective. That's how people "become themselves".

## The hard thing

It's not "collaboration". *It's social recognition for collaborators.* The recent entry about trust is driving agents to think it's a tool for collaboration like Notion. No. Creatives, collectives and collaboration are my strategy for adoption. What they adopt is *a new way to be seen*, not another tool they have to learn.

The hard thing is that something important in our lives is incredibly diffiult to capture. Be it inspiration, personality or creativity. Whatever you call it, the way society handle it is simply primitive when we need it to move life forward.

That's what I'm working on. We need some solid infrastructure around what makes us us. Just like modern people get recognised for their possession but agrarians didn't, we can get recognised for our character. We must in post-AI society.

Personae are for that. Not documentation for collaboration but for holding the essence of personality and character before they vaporise, so people can accumulate something one by one in their journey to create something unique and valuable and, hopefully, even create a growing feedback cycle of such thing.
