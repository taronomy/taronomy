...
This morning, it occured to me that the integration problem was not just the central theme to my work, but the life I always wanted. *The point was to bring the organising principles of society to its people.* And the thought really crystalised last year around the relationship between people and the system. People need to create frames each of them can prosper. It's more so now because the frame of scarcity is going away. 'Harder, better, faster, stronger' is reserved for machines.
...
Now, how does it answer my initial questions? What's the things that don't scale but enable scalable solutions? Looking back, what I wanted was to raise awareness and make connections. It was "talk to people". Obviously, the app is useless without a user. Without a user, I'm not likely to produce anything useful. That's why.
