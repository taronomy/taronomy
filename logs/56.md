...
In [symbolic world and society](#symbolic-world-and-society), I tell social plays apart from animalistic plays to explain why modern plays were not fun at all for the most. Even if the symbolic world is _at play_, it's not joyful when we don't know. Yet systems work indifferently.
...
Like it's been discussed in ["Enable Autonomy"](#enable-autonomy), that practice is creating something _what I am and what we are_. That's what I call 'autonomy'. It has many other names like meaning, purpose, creative context, higher order or enabling constraints. It's what happens when artists work except the artefact.
...
Claude pointed out the atoms of the ludic social systems is closer to _declaration_ than promise. It's closer to the attributes of a character. This could be the foundation?
