...
I'll delve into each and more in the project readme. But at the core, what makes the all possible and valuable is some *integrity between the persona and the author*. And it's tricky because this integrity should not be identity. The persona is not the author. The author should not pretend or assume the persona will be the perfect representation of themselves. What if the persona make promises the author can't keep or statements the author doesn't agree? There is this theatrical gap in between. The space is where all the value and risk live. The integrity should be functional, not identical.
