...
Likely competition is existing AI chat apps because they also enable self-awareness with context and memory reference. But, even if persona is the future, LLMs themselves are unlikely to drive people to such a conclusion. [Replika](https://replika.com), [Second Me](https://www.mindverse.ai),
...
*Ludic social systems* let us create and control personae we play in society. On this new social layer enabled by machine intelligence, we can recognise and communicate with one another free from traditions, institutions and identities.
