...
Something like that. It means, people have to treat a persona essentially a social delegate to the author knowing that it's separate from the author but it represents the author. And the features like mirror-me are just an attempt for that. The real value comes from how people would actually use that.

Now, should I start overly complicating that part? No. Right now, I just want a foundation where I can keep building. That's the groundwork where I can keep experimenting on top of. Let's clear that first.
