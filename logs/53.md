2023 CE
: Year of respite. Foused on self-awareness and recovery of sanity. Read books about the human body and mind. Made a research into learning experience design. Restructured vision around "studios". Finished CS50 with an Elixir project and ideated creator apps.
...
I reimagine society as a network of creative collaboration. And I call the actors in this network “studios”. They create projects of their own interests. Studios interact with one another largely to learn from or collaborate with. 

Consequently, they credit one another for such interactions, replacing the capital in terms of comprehensive consequence capture in society. This is how individuals and small groups can create their own powerful field of creative activity while contributing to society as a whole. 

This new model can supersede the limitations of the current social system and mitigate the harms of it. Individuals can maximise their potential, and life can be comprised of creative pursuits rather than material production and consumption, as they are much required for the post-AI society.
