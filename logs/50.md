...
If such activity has a single purpose, it is this: to make meaningful relationships. A meaningful relationship connects to John Dewey's definition of _growth_: the individual's transformation in the direction of social purpose. How, then, is 'success' defined? However it is defined, it will be proportional to the impact made on people's lives—including one's own. Dewey held that learning is the linking of relationships between successive experiences, and that education is the design of those links. _When we discover and enter into relation with who we were in the past, we learn and grow_. And when that growth affects others in society, we succeed.
