...
Whorf is a purely algorithmic layout. It's optimised for the shortest path travelled 2-dimensionally. The heart of Whorf is the vowels on the right-hand side. Sapir relocates consonants to add human factors. Least used keys are placed on the outer corners so pinkies don't have to reach out as much. Punctuations are placed for semantics and rhythm rather than least bigrams.

## Performance

- Low same finger bigram (SFB) %
...
- [Goodbye, Planck EZ](https://blog.zsa.io/2307-goodbye-planck-ez/)
