...
Progress can be organic when we try out different lives. With identity held softly, we can experiment with temporary social systems. That is how we rewrite the old rules we play by and grow human movement.
