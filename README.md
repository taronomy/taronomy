...
Progress can be organic when we try out different lives. With identity held softly, we can experiment with temporary social systems, rewrite the old rules we play by and grow human movement.

The act of commerce used to be considered parasitic. Agrarians did not see the value in moving things around and charging extra. Now, capitalism generates the most information about society.
